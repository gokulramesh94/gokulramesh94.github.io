...
const about = {
  ...
  imageSize: 375,
  message:
    "My name is Gokul. I have a Bachelors degree in Information Technology and a Post graduate certificate in Mobile Solutions Development. I'm most passionate about giving back to the community, and my goal is to pursue this passion within the field of software engineering. In my free time I like working on open source projects."
};
